...
COPY fixtures/db/schema.ts generated/schema.ts
# generated/schema.ts 在 .gitignore,git checkout 不带。fixtures/db/schema.ts 是
# commit 的完整 schema 副本(由本地 npm run gen:shared 后 cp 入 fixtures/ 同步)。
# 真实运行 schema 仍由 PG 提供(运行时 drizzle 走 PG 列名查表)。
