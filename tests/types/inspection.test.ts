...
describe("types/inspection M06 检测能力领域", () => {
  ...
  fnTest(
    ["M06.F02.I01"],
    "InspectionObject 携带 sourceProjectNo/sourceProjectName/sourcePage",
    () => {
  ...
  fnTest(
    ["M06.F03.I01"],
    "InspectionParameter 保存 rawName/canonicalName/methodText/aliases",
    () => {
  ...
  fnTest(
    ["M06.F05.I01"],
    "InspectionCalculationMethod 至少 object+parameter，可选 testingStandardCode",
    () => {
  ...
  fnTest(
    ["M06.F06.I01"],
    "InspectionTechnicalRequirement 必带 judgmentStandardCode+conditions+verificationStatus",
    () => {
  ...
  fnTest(
    ["M06.F01.I01"],
    "枚举常量：准备状态 catalogued/under-review/operational/disabled",
    () => {
  ...
  fnTest(
    ["M06.F02.I01"],
    "类型守卫：InspectionObject 禁止 projectId/InspectionProject/InspectionObjectVariant/InspectionScheme 字段",
    () => {
