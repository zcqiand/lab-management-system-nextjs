...
describe("reports 4 阶段页（M03.F05-F08）", () => {
  ...
  fnTest(
    ["M03.F05.I07"],
    "审核通过动作穿透：review 单据 submit 后流入批准环节",
    async () => {
      render(<ReportReviewPage />);
      ...
      const approveBtn = row.querySelector(
        '[data-fn="M03.F05.I07"]',
  ...
  fnTest(
    ["M03.F05.I07"],
    "flow 适配多阶段连续流转：data_entry → review → approval",
    async () => {
      ...
      const submitBtn = entryRow.querySelector(
        '[data-fn="M03.F03.I02"]',
      ) as HTMLButtonElement;
      ...
      const approveBtn = reviewRow.querySelector(
        '[data-fn="M03.F05.I07"]',
      ) as HTMLButtonElement;
      await userEvent.click(approveBtn);
      await waitFor(() => {
