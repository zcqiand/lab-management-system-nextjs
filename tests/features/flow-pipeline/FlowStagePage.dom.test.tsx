...
describe("FlowStagePage 行级按钮 data-fn 锚点（4 个 Report 页面共用）", () => {
  ...
  fnTest(
    ["M03.F05.I01", "M03.F05.I02", "M03.F05.I07", "M03.F05.I04"],
    "审核页：查看详情 + 审核通过 按钮挂 data-fn",
    async () => {
      ...
      await waitFor(() => {
        expect(
          container.querySelectorAll('[data-fn="M03.F05.I02"]').length,
        ).toBeGreaterThan(0);
        expect(
          container.querySelectorAll('[data-fn="M03.F05.I07"]').length,
        ).toBeGreaterThan(0);
      });
    },
  );
  ...
  fnTest(
    ["M03.F06.I01", "M03.F06.I02", "M03.F06.I05", "M03.F06.I04"],
    "批准页：查看详情 + 批准 按钮挂 data-fn",
    async () => {
      ...
      await waitFor(() => {
        expect(
          container.querySelectorAll('[data-fn="M03.F06.I02"]').length,
        ).toBeGreaterThan(0);
        expect(
          container.querySelectorAll('[data-fn="M03.F06.I05"]').length,
        ).toBeGreaterThan(0);
      });
    },
  );
  ...
  fnTest(
    ["M03.F07.I01", "M03.F07.I02", "M03.F07.I05", "M03.F07.I04"],
    "发放页：查看详情 + 发放 按钮挂 data-fn",
    async () => {
      ...
      await waitFor(() => {
        expect(
          container.querySelectorAll('[data-fn="M03.F07.I02"]').length,
        ).toBeGreaterThan(0);
        expect(
          container.querySelectorAll('[data-fn="M03.F07.I05"]').length,
        ).toBeGreaterThan(0);
      });
    },
  );
  ...
  fnTest(
    ["M03.F08.I01", "M03.F08.I02", "M03.F08.I05", "M03.F08.I04"],
    "归档页：查看详情 + 归档 按钮挂 data-fn",
    async () => {
      ...
      await waitFor(() => {
        expect(
          container.querySelectorAll('[data-fn="M03.F08.I02"]').length,
        ).toBeGreaterThan(0);
        expect(
          container.querySelectorAll('[data-fn="M03.F08.I05"]').length,
        ).toBeGreaterThan(0);
      });
    },
  );
