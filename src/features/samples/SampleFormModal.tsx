...
export function SampleFormModal({
  ...
  const [structuralPart, setStructuralPart] = useState(
    initialValues?.structuralPart ?? "",
  );
  const [representQuantity, setRepresentQuantity] = useState(
    initialValues?.representQuantity ?? "",
  );
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      <form
        ...
        className="bg-white rounded-lg shadow-xl w-140 max-w-[90vw]"
      >
        ...
        <div className="px-6 py-4 space-y-4">
          <div>
            <label htmlFor="sample-project" className="block text-sm mb-1 font-medium">
              所属项目
            </label>
            <input
              id="sample-project"
            ...
            />
            {errors.projectId && (
              <p className="text-red-600 text-xs mt-1">{errors.projectId}</p>
            )}
          </div>
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label htmlFor="sample-name" className="block text-sm mb-1 font-medium">
                样品名称
              </label>
              <input
                id="sample-name"
            ...
            <div>
              <label htmlFor="sample-code" className="block text-sm mb-1 font-medium">
                样品编号
              </label>
              <input
                id="sample-code"
          ...
          <div className="grid grid-cols-3 gap-4">
            <div>
              <label htmlFor="sample-mfr" className="block text-sm mb-1 font-medium">
                生产厂家
              </label>
              <input
                id="sample-mfr"
            ...
            <div>
              <label htmlFor="sample-struct" className="block text-sm mb-1 font-medium">
                结构部位
              </label>
              <input
                id="sample-struct"
            ...
            <div>
              <label htmlFor="sample-rep-qty" className="block text-sm mb-1 font-medium">
                代表数量
              </label>
              <input
                id="sample-rep-qty"
